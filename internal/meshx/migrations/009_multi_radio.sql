...
-- key so the daemon (PR #3) can fan out to N radios without a schema
-- migration later. PR #1 still runs against a single radio in
-- practice; the column exists for forward-compat.
--
